...
// Copyright (c) 2017-2017 The Terracoin Core developers
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 5000 TERRACOIN - checking if valid masternode)
